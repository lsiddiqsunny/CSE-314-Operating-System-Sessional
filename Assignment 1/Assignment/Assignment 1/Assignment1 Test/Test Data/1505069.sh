        ...
        then
           ...
           then 
                ...
                then 
                    ...
                    if [ "$var3" = "$var5" ]
                    then 
                        var3="$(grep -i "$var2" ../CSE_322.csv|cut -d',' -f1)" 
                        mv "$var4" "$var3"
                        mv "$var3" ../output
                        ...
                        var3="$(grep -i "$var2" ../CSE_322.csv|cut -d',' -f1)" #taking matched roll number
                        rem=""
                        var5="1"
                        for j in $var3
                        do
        ...
        then 
            ...
            echo "$(grep -v $var1 ../output/absent.txt)">../output/absent.txt #removing roll from absent list
                    ...
                    then 
                        ...
                        count=$((0))  #counting from zero
                        var2="$(echo $i|cut -d'_' -f1)" #student name
                        var3="$(grep -i "$var2" ../CSE_322.csv|cut -d',' -f1)" #taking matchedr roll numbe
                        rem=""
                        var5="1"
                        for j in $var3
                        do
...
#take roll from absent list
abs="$(cat output/absent.txt)"
for i in $abs
do
    #input data into marks list
    echo "$i-0">>output/marks.txt
done
#sorting marks list
echo "$(cut -d'-' -f1- output/marks.txt |sort)">output/marks.txt
unset IFS
rm check2.txt
rm check3.txt
rm check4.txt
